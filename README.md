...
- `firmware-update_safe.wave` — the correct design.
- `firmware-update_unsafe.wave` — the tempting-but-wrong version (the negative example a model must learn to reject).
